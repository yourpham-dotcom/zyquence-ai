...
const MOCK_NEWS: NewsItem[] = [
  { id: "1", title: "OpenAI Announces GPT-6 with Real-Time Reasoning", source: "TechCrunch", category: "AI", time: "2h ago" },
  { id: "2", title: "Apple Unveils New M5 Chip Architecture", source: "The Verge", category: "Technology", time: "3h ago" },
  { id: "3", title: "S&P 500 Hits All-Time High Amid AI Boom", source: "Bloomberg", category: "Finance", time: "4h ago" },
  { id: "4", title: "NBA Playoff Race Heats Up as Trade Deadline Approaches", source: "ESPN", category: "Sports", time: "5h ago" },
  { id: "5", title: "Spotify Launches AI-Powered DJ for Podcasts", source: "Wired", category: "Music", time: "6h ago" },
  { id: "6", title: "Y Combinator's W26 Batch: Record Number of AI Startups", source: "Forbes", category: "Startups", time: "7h ago" },
  { id: "7", title: "Remote Work Study: Productivity Up 23% With AI Tools", source: "HBR", category: "Business", time: "8h ago" },
  { id: "8", title: "New Wellness Apps Leverage AI for Personalized Health", source: "Healthline", category: "Health", time: "9h ago" },
];
      ...
      <ScrollArea className="w-full">
        <div className="flex gap-3 pb-3">
          {filteredNews.map((item) => (
            <Card
              key={item.id}
              className="group min-w-[260px] max-w-[280px] shrink-0 border-border/50 hover:border-primary/30 bg-card/80 backdrop-blur-sm transition-all duration-200 hover:shadow-md hover:-translate-y-0.5 overflow-hidden"
            >
