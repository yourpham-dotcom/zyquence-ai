...
import { Loader2, Save, Palette, Upload, X, FileAudio, Link2, ExternalLink, Music2 } from "lucide-react";
      ...
      <div className="flex flex-col items-center justify-center h-full gap-6 p-8">
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-sm text-muted-foreground max-w-md">
            Paste your Spotify or SoundCloud link, or upload your music — AI analyzes your actual sound to build your brand direction
          </p>
        </div>
  ...
  if (loading) return (
    <div className="flex flex-col items-center justify-center h-full gap-4">
      ...
      <p className="text-sm text-muted-foreground">
        {analysisMode === "audio" ? "Analyzing your uploaded music..." : "Fetching & analyzing your track..."}
      </p>
    </div>
  );
  ...
  return (
    <div className="p-6 space-y-6 overflow-y-auto max-h-full">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-xl font-bold text-foreground">Branding</h2>
          <p className="text-sm text-muted-foreground">Your brand direction based on your music</p>
        </div>
        <div className="flex gap-2">
