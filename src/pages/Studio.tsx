              ...
              <TooltipTrigger asChild>
                <DropdownMenuTrigger asChild>
                  <Button
                    variant="ghost"
                    size={sidebarWidth > 64 ? "default" : "icon"}
                    className={`${isCreativeToolActive ? "bg-primary text-primary-foreground" : "hover:bg-accent"} ${sidebarWidth > 64 ? "w-full justify-start px-4" : ""}`}
                    style={sidebarWidth > 64 ? { width: `${sidebarWidth - 16}px` } : {}}
                  >
                    <Wrench className="h-5 w-5" />
                    {sidebarWidth > 100 && <span className="ml-2 text-sm">Creative & Code</span>}
                  </Button>
                </DropdownMenuTrigger>
              </TooltipTrigger>
              <TooltipContent side="right">Creative & Code</TooltipContent>
            </Tooltip>
            <DropdownMenuContent side="right" align="start" className="w-52 bg-popover border-border">
