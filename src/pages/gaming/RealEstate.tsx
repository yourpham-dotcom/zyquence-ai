...
import { ArrowLeft, Building, Home, DollarSign } from "lucide-react";
  ...
  const propertyTypes = [
    {
      ...
      income: 1200,
      icon: "🏠",
      description: "Small but steady rental income"
    },
    {
      name: "Family Home",
      cost: 150000,
      income: 2500,
      icon: "🏡",
      description: "Perfect for long-term renters"
    },
    {
      name: "Airbnb Condo",
      cost: 200000,
      income: 4000,
      icon: "🏢",
      description: "High income from short stays"
    },
    {
      ...
      income: 6000,
      icon: "🏬",
      description: "Business rental for stable income"
    },
    {
      name: "Luxury Villa",
      cost: 500000,
      income: 10000,
      icon: "🏰",
      description: "Premium property, premium rent"
    },
    {
      ...
      income: 15000,
      icon: "🏛️",
      description: "Multiple units, massive income"
    }
  ];
      ...
      <div className="container mx-auto p-6 space-y-8">
        ...
        <div className="space-y-2">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-4xl font-bold">Real Estate Empire</h1>
          </div>
        ...
        <div className="grid md:grid-cols-3 gap-4">
          <Card className="p-4">
            <div className="flex items-center gap-2">
              ...
              <Badge variant="secondary" className="text-lg">${cash.toLocaleString()}</Badge>
            </div>
            <p className="text-xs text-muted-foreground mt-1">Available Cash</p>
          </Card>
          <Card className="p-4">
            <div className="flex items-center gap-2">
              <Badge variant="secondary" className="text-lg text-green-600">+${monthlyIncome}/mo</Badge>
            </div>
          ...
          <Card className="p-4">
            <div className="flex items-center gap-2">
              ...
              <Badge variant="secondary" className="text-lg">{properties.length}</Badge>
            </div>
